-- Expose duration_days in match_routes so AI search and clients can show
-- multi-day templates correctly. Pure additive change to the return shape;
-- scoring logic unchanged from migration 042.
