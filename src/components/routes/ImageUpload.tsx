  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          borderColor: dragging ? "#F4632A" : "#E4E4E7",
          backgroundColor: dragging ? "#FFF5F2" : "#FAFAF9",
        }}
      >
        <div
        ...
        <div className="mt-3 grid grid-cols-3 sm:grid-cols-4 gap-2">
          {images.map((src, i) => (
            <div key={i} className="relative group aspect-square rounded-xl overflow-hidden border border-[#E4E4E7]">
              ...
              {/* Order badge */}
              <div
                className="absolute bottom-1 left-1 text-[10px] font-bold px-1.5 py-0.5 rounded-md"
